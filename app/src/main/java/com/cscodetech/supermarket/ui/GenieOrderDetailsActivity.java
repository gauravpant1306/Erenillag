    ...
    private void setDataListItems(int a, String comment) {
        switch (a) {
            case 0:
                ...
                mDataList.add(new TimeLineModel("Accepted Searching Delivery Boy.", "", OrderStatus.INACTIVE));
                mDataList.add(new TimeLineModel("Waiting For Delivery Boy Decision.", "", OrderStatus.INACTIVE));
                mDataList.add(new TimeLineModel("Delivery Boy Accepted Order.", "", OrderStatus.INACTIVE));
            ...
            case 1:
                ...
                mDataList.add(new TimeLineModel("Accepted Searching Delivery Boy.", "", OrderStatus.ACTIVE));
            ...
            case 3:
                mDataList.add(new TimeLineModel("Waiting For Store Decision.", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Accepted Searching Delivery Boy.", "", OrderStatus.COMPLETED));
            ...
            case 7:
                ...
                mDataList.add(new TimeLineModel("Delivery Boy Accpeted Order.", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Delivery Boy Pick up Order.", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Delivery Boy Complete Order.", "", OrderStatus.COMPLETED));
                break;
            case 8:
                mDataList.add(new TimeLineModel("Waiting For Store Decision.", "", OrderStatus.COMPLETED));
            ...
            case 9:
                ...
                mDataList.add(new TimeLineModel("Waiting For Delivery Boy Decision.", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Delivery Boy Accpeted Order.", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Delivery Boy Cancelled Order.", comment, OrderStatus.COMPLETED));
                break;
            case 10:
//                mDataList.add(new TimeLineModel("Waiting For Store Decision.", "", OrderStatus.COMPLETED));
//                mDataList.add(new TimeLineModel("Accepted Searching Delivery Boy.", "", OrderStatus.COMPLETED));
